    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'E:/INTERNSHIP/AICTE/FACE/Attendance-Management-System/Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"E:\INTERNSHIP\AICTE\FACE\Attendance-Management-System\Attendance-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("E:\INTERNSHIP\AICTE\FACE\Attendance-Management-System\TrainingImageLabel\Trainner.yml")
                except:
                ...
                df = pd.read_csv("E:\INTERNSHIP\AICTE\FACE\Attendance-Management-System\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = 'E:/INTERNSHIP/AICTE/FACE/Attendance-Management-System' + fileName
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'shreepati' and password == 'shreepati':
            ...
            cs = "E:/INTERNSHIP/AICTE/FACE/Attendance-Management-System/StudentDetails/StudentDetails.csv"
                ...
                with open(cs, newline="") as file:
                    ...
                    for row in reader:
                        ...
                        for item in row:
                            ...
                            label = tk.Label(root, text=item, relief=tk.RIDGE, width=20, height=2, font=('times', 12, 'bold'), bg="white")
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
...
def trainimg():
    ...
    try:
        recognizer.save("E:\INTERNSHIP\AICTE\FACE\Attendance-Management-System\TrainingImageLabel\Trainner.yml")
    except Exception as e:
